...
public class ChatGpt {
	...
	public static ReplyMsg getGptForGroup(String raw_message){
        ...
        Message system = Message.ofSystem(MsbotConst.group_prompt);
	...
	public static ReplyMsg getGptForUser(String raw_message){
		if(MsbotConst.gpt_apiKey==null||MsbotConst.gpt_apiKey.isEmpty()) {
			return null;
		}
		
		if(raw_message.length()>2) {
			raw_message = raw_message.substring(2,raw_message.length());
		}
        ...
        Message system = Message.ofSystem(MsbotConst.user_prompt);
        Message message = Message.of(raw_message);
