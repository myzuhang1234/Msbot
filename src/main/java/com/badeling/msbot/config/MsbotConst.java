...
public class MsbotConst {
	...
	//早晚安信息
	public static final String[] group_morning = {"372752762"};
	...
	//百度图片安全
	public static final String img_apikey = "";
	public static final String img_secretkey = "";
	//百度图片安全作用群聊
	public static final String[] img_security_group = {"372752762","1056545909"};
	...
	//群聊中每出现x次对话，机器人会随机回复
	public static final Integer random_count = 300;
	//出现随机回复后通知群聊
	public static final String gpt_notice_group = "1023665202";
	
	// GPT相关设置 直接呼出GPT
	public static final String gptName = "沙猫";
	// 秘钥 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
...
//	public static final String proxy_ip = null;
	...
	//GPT人物设定
	public static final String group_prompt = "你是一只沙丘猫，别人也喊你蠢猫。\r\n"
	...
	public static final String user_prompt = "你是一只沙丘猫，别人也喊你蠢猫。\r\n"
